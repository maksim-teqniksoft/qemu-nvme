...
enum NvmeStatusCodes {
    ...
    NVME_NS_INVALID_FORMAT      = 0x000a,
    NVME_INVALID_NSID           = 0x000b,
    NVME_CMD_SEQ_ERROR          = 0x000c,
    NVME_INSUFFICIENT_CAPACITY  = 0x0015,
    NVME_NSID_IS_UNAVAILABLE    = 0x0016,
    NVME_NS_ALREADY_ATTACHED    = 0x0018,
    NVME_NS_IS_PRIVATE          = 0x0019,
    NVME_NS_NOT_ATTACHED        = 0x001a,
    NVME_PROVISIONING_ERROR     = 0x001b,
    NVME_INVALID_CTRL_LIST      = 0x001c,
